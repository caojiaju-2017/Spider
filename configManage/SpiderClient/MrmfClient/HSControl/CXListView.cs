...
namespace SpiderC.HSControl
{
    public partial class CXListView : ListView
    {
        ...
        protected override void OnDrawColumnHeader(DrawListViewColumnHeaderEventArgs e)
        {
            ...
            e.Graphics.FillRectangle(new SolidBrush(ColorTranslator.FromHtml("#666633")), e.Bounds);
            ...
            e.Graphics.DrawString(this.Columns[e.ColumnIndex].Text, new Font("宋体", 10), new
                         SolidBrush(Color.White), e.Bounds, stringFormat);

            e.Graphics.DrawLine(new Pen(Color.FromArgb(200, 200, 200)), (float)(e.Bounds.Right - 0.5),
