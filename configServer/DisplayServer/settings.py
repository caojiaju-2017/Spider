...
"""
Django settings for DisplayServer project.
...
SECRET_KEY = 'g^4)=h@ir_n!azd^wh8*+p6*y1#uvsjd%d4lzyv_egwyj^$hi_'
...
ALLOWED_HOSTS = ['127.0.0.1', 'localhost','192.168.1.102','192.168.1.104','115.159.224.102','192.168.1.209']
...
ROOT_URLCONF = 'DisplayServer.urls'
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'DSServer')
