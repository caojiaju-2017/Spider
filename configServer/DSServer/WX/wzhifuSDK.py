...
class WxPayConf_pub(object):
    ...
    NOTIFY_URL = "http://www.h-sen.com/payback"

    #=======【JSAPI路径设置】===================================
    #获取access_token过程中的跳转uri，通过跳转将code传入jsapi支付页面
    JS_API_CALL_URL = "http://www.h-sen.com/pay/?showwxpaytitle=1"

    #=======【证书路径设置】=====================================
    #证书路径,注意应该填写绝对路径
    SSLCERT_PATH = "/www.h-sen/cacert/apiclient_cert.pem"
    SSLKEY_PATH = "www.h-sen/cacert/apiclient_key.pem"
