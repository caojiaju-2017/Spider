...
import tender.hs.tenderclient.Login.LoginActivity;

public class Guide extends Activity implements OnPageChangeListener {

	private ViewPager vp;
	private tender.hs.tenderclient.ViewPagerAdapter vpAdapter;
	...
	private void initViews() {
		...
		start_btn = (TextView) views.get(2).findViewById(R.id.start_btn);
