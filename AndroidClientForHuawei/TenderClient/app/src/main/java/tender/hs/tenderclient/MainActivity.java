...
import tender.hs.tenderclient.HsListView.BookItemAdapter;
import tender.hs.tenderclient.HsListView.DisplayUtils;
import tender.hs.tenderclient.HsListView.QueryInfo;
import tender.hs.tenderclient.HsListView.XListView;
import tender.hs.tenderclient.Report.ColumnReportService;
import tender.hs.tenderclient.Report.PieReportService;
import tender.hs.tenderclient.Report.ReportObject;
import tender.hs.tenderclient.Report.LineReportService;
import tender.hs.tenderclient.Util.LogUtil;
import tender.hs.tenderclient.wxapi.WXEntryActivity;
        ...
        XListView.IXListViewListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (HsApplication.Global_App.globalWay == ClientWay.HuaWei)
        {
            // 调用鉴权方法
